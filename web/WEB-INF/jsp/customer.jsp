		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="customerList.action" class="active"><i class="fa fa-edit fa-fw"></i> 客户管理</a></li>
					<li><a href="salevisit.action"><i class="fa fa-dashboard fa-fw"></i> 客户拜访</a></li>
				</ul>
			</div>
			<!-- /.sidebar-collapse -->
		</div>
				...
				<div class="panel-body" align="center">
					<form class="form-inline" action="${pageContext.request.contextPath }/customerList.action" method="get">
						<div class="form-group">
							<label for="customerName">客户名称</label>&emsp;
							<input type="text" style="width: 110px;" class="form-control" id="customerName" value="${custName }" name="custName">
						</div>
						&emsp;&emsp;
						<div class="form-group">
							<label for="customerFrom">客户来源</label>&emsp;
						...
						&emsp;&emsp;
						<div class="form-group">
							<label for="custIndustry">所属行业</label>&emsp;
						...
						&emsp;&emsp;
						<div class="form-group">
							<label for="custLevel">客户级别</label>&emsp;
							...
							<tbody>
								<c:forEach items="${page.rows}" var="row">
									<tr align="center">
										...
										<td>
											<a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerEditDialog" onclick="editCustomer(${row.cust_id})">修 改</a>
											&emsp;
											<a href="#" class="btn btn-danger btn-xs" onclick="deleteCustomer(${row.cust_id})">删 除</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
...
<script type="text/javascript">
		...
		function updateCustomer() {
			$.post("<%=basePath%>updateCustomer.action",$("#edit_customer_form").serialize(),function(data){
				alert("客户信息更新成功！");
		...
		function deleteCustomer(id) {
			if(confirm('确实要删除该客户吗?')) {
				$.post("<%=basePath%>deleteCustomer.action",{"id":id},function(data){
					alert("客户删除更新成功！");
					window.location.reload();
				});
			}
